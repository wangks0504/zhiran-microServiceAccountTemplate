package com.zhiran.common.entity;
...
public class SessionContext {
    ...
    private String generateSessionId() {
        return ZhiranConstants.SESSION_TOKEN_PREFIX + String.valueOf(idWorker.nextId());
    }
    ...
    public static String getAccountTokenKey(String accountId) {
        return ZhiranConstants.ACCOUNT_TOKEN_PREFIX + accountId;
    }
